package com.example.tempatpelayanankesehatan
...
import kotlinx.android.synthetic.main.activity_rumahsakit.*
...
class HospitalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvRS.layoutManager = LinearLayoutManager(this)
        ...
        rvRS.adapter = RecyclerViewAdapterLocation(this, null)
    ...
    private fun loadClinicList(myLocation: String?) {
        ...
        ApiConfig().instance().json(ApiConfig.API_KEY, "rumah sakit", myLocation, "distance")
